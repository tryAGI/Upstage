...
{
    /// <inheritdoc />
    public sealed class ChatCompletionMessageRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Upstage.ChatCompletionMessageRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::Upstage.ChatCompletionMessageRoleExtensions.ToValueString(value));
        }
    }
}
